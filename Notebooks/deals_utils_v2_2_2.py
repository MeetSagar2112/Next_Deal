...
def return_perc_aum(aum_value):
    if np.logical_and(aum_value >= 1000000, aum_value < 2000000):
        return 10
    elif np.logical_and(aum_value >= 2000000, aum_value < 3000000):
        return 5
    elif np.logical_and(aum_value >= 3000000, aum_value < 4000000):
        return 3.3
    elif np.logical_and(aum_value >= 5000000, aum_value < 6000000):
        return 2.5
    elif np.logical_and(aum_value >= 6000000, aum_value < 30000000):
        return 2
    elif np.logical_and(aum_value >= 30000000, aum_value < 50000000):
        return 1.7
    elif aum_value >= 50000000:
        return 1.5
    elif aum_value < 1000000:
        return 20


def deal_sizing(clientid, max_substrategy, expo_df, max_substrat_df, deals_df, client_deals, topup, top_n_deals,top_aum_criteria_perc, min_value_topup):
    ...
    Updated_deal_allocation_aum = return_perc_aum(aum_value)
    ...
    print('deals upd')
    print(deals_available_sub_strategy_upd)
    deals_available_sub_strategy_upd['Delta_allocation'] = deals_available_sub_strategy_upd['UPD_MEDIAN'] - deals_available_sub_strategy_upd['MARKET_VALUE_REF']
...
def deal_recommendation_ips(expo_df, suggest_substrat_df, top_n_deals, deals_available_sub_strategy, substrategy_def, top_aum_criteria_perc,  min_value_topup):
    deals_available_sub_strategy.reset_index(inplace= True, drop = True)
...
def deal_sizing_ips(clientid,expo_df_def1, suggest_substrat_df_def1, deals_df_def1, client_deals_def1, topup, top_n_deals_def1,  top_aum_criteria_perc, min_value_topup):
    ...
    if suggest_substrat_df_def1['Suggest_CG'][0] == True:
        ...
        final_cg_df = deal_recommendation_ips(expo_df = expo_df_def1, suggest_substrat_df = suggest_substrat_df_def1, top_n_deals = top_n_deals_def1, deals_available_sub_strategy = deals_available_sub_strategy_def1, substrategy_def = 'CG', top_aum_criteria_perc = top_aum_criteria_perc, min_value_topup = min_value_topup)
    ...
    if suggest_substrat_df_def1['Suggest_CY'][0] == True:
        ...
        final_cy_df = deal_recommendation_ips(expo_df = expo_df_def1, suggest_substrat_df = suggest_substrat_df_def1, top_n_deals = top_n_deals_def1, deals_available_sub_strategy = deals_available_sub_strategy_def1, substrategy_def = 'CY', top_aum_criteria_perc = top_aum_criteria_perc, min_value_topup = min_value_topup)
